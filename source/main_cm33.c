...
int main(void)
{
    ...
    PRINTF("\r\nlimiter_16:\r\n");
    measure_algorithm_time_16(limiter_16, (uint16_t *)s_Buffer_1, (S_BUFFER_SIZE / 2), ITER_COUNT);
//    PRINTF("\r\nlimiter_8:\r\n");
//    measure_algorithm_time_8(limiter_8, (uint8_t *)s_Buffer_1, (S_BUFFER_SIZE), ITER_COUNT);
    PRINTF("\r\ncompressor_expander_ngate_16:\r\n");
    measure_algorithm_time_16(compressor_expander_ngate_16, (uint16_t *)s_Buffer_1, (S_BUFFER_SIZE / 2), ITER_COUNT);
//    PRINTF("\r\ncompressor_expander_ngate_8:\r\n");
//    measure_algorithm_time_8(compressor_expander_ngate_8, (uint8_t *)s_Buffer_1, (S_BUFFER_SIZE), ITER_COUNT);
